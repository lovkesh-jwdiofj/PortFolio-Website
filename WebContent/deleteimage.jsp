...
<title>Delete Header Image</title>
...
<% 
Read r = new Read();
	ArrayList<Image> al =r.readImage();
...
%>
    ...
    <tbody>
        <tr class="active-row">
            <td><%=p.getName()%></td>
            <td><%=p.getFilename() %></td>
            <td>  <img style="height: 100px;width: 150px" src="header image/project/<%=p.getFilename() %>" class="img-fluid" ></td>
